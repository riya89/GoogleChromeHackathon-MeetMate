...
// let captionSimplificationEnabled = true;
...
// // 🔧 FIXED: Initialize sessions with proper image support configuration
...
//     // Text session for notes and actionables
...
//     // 🔧 FIXED: Image session with proper multimodal configuration
//     console.log("📸 [INIT] Creating image session (multimodal)...");
//     try {
//       // Create session with expectedInputs for image support
...
//       if (imageSession.expectedInputs) {
//         console.log("✅ Session expectedInputs:", imageSession.expectedInputs);
//       } else {
//         console.warn("⚠️ Session created but expectedInputs not confirmed");
//       }
      
//     } catch (imgErr) {
//       console.error("❌ Failed to create image session:", imgErr);
//       console.error("This usually means multimodal support is not enabled in Chrome");
//       imageSession = null;
//       status.textContent = "⚠️ Screenshot analysis unavailable - enable multimodal in chrome://flags";
//     }
...
//     status.textContent = imageSession ? "✅ All AI features ready (including screenshots)" : "⚠️ AI ready (screenshot analysis unavailable)";
